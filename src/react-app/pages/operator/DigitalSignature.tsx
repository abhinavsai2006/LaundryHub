      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600">Capture and manage digital signatures for accountability</p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <GlassCard className="p-6">
                <h2 className="text-xl font-bold text-gray-900 mb-4">Capture New Signature</h2>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 mb-4">
                  <div className="flex items-center justify-between mb-2">
                    <p className="text-sm text-gray-600">Signature Area</p>
                  ...
                  <canvas
                    ...
                    width={400}
                    height={200}
                    className="border border-gray-200 rounded bg-white cursor-crosshair w-full touch-manipulation"
            ...
            <div className="space-y-6">
              <GlassCard className="p-6">
                <h2 className="text-xl font-bold text-gray-900 mb-4">Signature Records</h2>
                ...
                {signatures.length === 0 && (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500">No signatures captured yet</p>
                  </div>
                )}
              </GlassCard>
            </div>
